...
// Fetches their saved sectors via /api/territory/franchisee-summary
// and renders them coloured-in. Also exposes a "Check a postcode"
// input — type any UK postcode and we tell them whether it sits inside
// their territory.
...
export default function FranchiseeTerritoryWidget({ franchiseeId }) {
  ...
  return (
    <div className="bg-white border border-stone-200 rounded-2xl p-6 space-y-4" data-testid="portal-territory">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          ...
          {hasTerritory ? (
            <h2 className="font-display text-2xl text-stone-950">{summary.home_count} care homes across {summary.sectors.length} sectors</h2>
          ) : (

    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { kind: "item", to: "/admin/contracts", label: "Contracts", icon: FileText, testid: "nav-admin-contracts", permKey: "admin-contract-templates" },
          { kind: "item", to: "/admin/markers-library", label: "Marker Library", icon: FileText, testid: "nav-admin-markers-library", permKey: "admin-contract-templates" },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { kind: "item", to: "/admin/email-templates", label: "Email Templates",           icon: Mail,        testid: "nav-admin-email-templates", permKey: "admin-email-templates" },
          { kind: "item", to: "/admin/landing-pages",   label: "Landing Pages",             icon: ExternalLink, testid: "nav-admin-landing-pages",  permKey: "admin-landing-pages" },
          { kind: "item", to: "/admin/inbound-unmatched", label: "Unmatched Replies",       icon: Inbox,        testid: "nav-admin-inbound-unmatched-mobile", permKey: "admin-inbound-unmatched" },

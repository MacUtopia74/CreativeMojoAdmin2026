...
const Clients = () => {
  ...
  const fetchClients = async () => {
    try {
      const response = await api.get("/portal/invoices/clients");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingClient) {
        await api.put(`/portal/invoices/clients/${editingClient.id}`, formData);
        toast.success("Client updated successfully");
      } else {
        await api.post("/portal/invoices/clients", formData);
  ...
  const deleteClient = async (clientId) => {
    try {
      await api.delete(`/portal/invoices/clients/${clientId}`);

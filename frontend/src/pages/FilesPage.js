...
// ---------------------------------------------------------------------------
// Preview modal — admin Files page delegates to the SHARED FilePreviewModal
// (same component used by the franchisee portal). Keeping a single source of
// truth here matters: the "Full page preview tries to save the file" bug
// recurred twice precisely because this page had its own duplicate modal
// that we kept forgetting to update. If you need to tweak preview rendering
// behaviour, edit `/app/frontend/src/components/files/FilePreviewModal.jsx`
// once and both surfaces inherit the fix.

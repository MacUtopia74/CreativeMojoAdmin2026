          ...
          <main className="col-span-12 md:col-span-9 space-y-3">
            {trashMode ? (
              ...
              <>
                ...
                <div className="bg-[#EEEE86] border-2 border-stone-900 rounded-2xl px-5 py-4 flex items-center justify-between gap-3 flex-wrap shadow-sm" data-testid="files-tree">

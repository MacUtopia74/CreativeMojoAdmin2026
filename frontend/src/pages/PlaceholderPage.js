...
export default function PlaceholderPage({ title, subtitle, phase = "Phase 1", description }) {
  return (
    <div className="min-h-screen">
      ...
      <div className="p-12">
        <div className="max-w-xl bg-white border border-stone-200 p-10" data-testid={`placeholder-${title.toLowerCase()}`}>
          <div className="w-10 h-10 bg-[#D4FF00] flex items-center justify-center mb-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 mt-6 px-4 py-2 bg-stone-950 text-white text-xs font-bold uppercase tracking-wider hover:bg-stone-800 transition-colors"
